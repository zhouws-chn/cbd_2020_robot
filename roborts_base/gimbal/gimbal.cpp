...
void Gimbal::ROS_Init(){
  ...
  camera_tf_.header.frame_id = "base_link";
  camera_tf_.child_frame_id = "camera";
}
...
#if 1
 geometry_msgs::Quaternion camera_q = tf::createQuaternionMsgFromRollPitchYaw(0.0, 0.0,
                                                                        gimbal_info->yaw_ecd_angle / 1800.0 * M_PI);
  camera_tf_.header.stamp = current_time;
  camera_tf_.transform.rotation = camera_q;
  camera_tf_.transform.translation.x = 0.09;
  camera_tf_.transform.translation.y = 0;
  camera_tf_.transform.translation.z = 0.28;

...
public:
  ...
  {
    IDLE_MODE,            ///< Default idle mode with no task 默认空闲模式，没有任务
    GOAL_MODE,            ///< Goal-targeted task mode using global and local planner
    SPEED_MODE,           ///< Velocity task mode  速度任务模式
    SPEED_WITH_ACCEL_MODE ///< Velocity with acceleration task mode 具有加速任务模式的速度
  };
  /**

#ifndef ROBORTS_DECISION_BACKBONUSBEHAVIOR_H
#define ROBORTS_DECISION_BACKBONUSBEHAVIOR_H
...
{
class BackBonusBehavior
{
public:
  BackBonusBehavior(ChassisExecutor *&chassis_executor,
...
#endif //ROBORTS_DECISION_BACKBONUSBEHAVIOR_H

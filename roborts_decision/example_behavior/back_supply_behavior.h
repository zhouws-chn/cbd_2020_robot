#ifndef ROBORTS_DECISION_BACKSUPPLYBEHAVIOR_H
#define ROBORTS_DECISION_BACKSUPPLYBEHAVIOR_H
...
{
class BackSupplyBehavior
{
public:
  BackSupplyBehavior(ChassisExecutor *&chassis_executor,
  ...
  void Run()
  {
    ...
    std::cout << "supply ExcutionMode:" << execution_mode_ << std::endl;
  ...
  bool LoadParam(const std::string &proto_file_path)
  {
    ...
    boot_position_.header.frame_id = "map";
    boot_position_.pose.position.x = decision_config.supply_bot().start_position().x();
    boot_position_.pose.position.z = decision_config.supply_bot().start_position().z();
    boot_position_.pose.position.y = decision_config.supply_bot().start_position().y();

    std::cout << "supplyPosition  x " << boot_position_.pose.position.x << std::endl;
    std::cout << "supplyPosition  z " << boot_position_.pose.position.z << std::endl;
    std::cout << "supplyPosition  y " << boot_position_.pose.position.y << std::endl;
...
#endif //ROBORTS_DECISION_BACKSUPPLYBEHAVIOR_H
